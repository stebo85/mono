...
- Updated niivue to 1.0.0-rc.10

## 1.0.0-rc.9 (2026-06-12)

### Updated Dependencies

- Updated niivue to 1.0.0-rc.9
...
- **ci:** build deps before typecheck in dependent projects ([6786645](https://github.com/niivue/mono/commit/6786645))

### Updated Dependencies

- Updated niivue to 1.0.0-rc.2
...
This was a version bump only for nv-ext-image-processing to align it with other projects, there were no code changes.